...
def compute_cost_and_grad(theta, instances, word_vectors, embsize, lambda_reg):
    if rank == 0:
        pass
    else:
        pass
...
def init_rae_theta(embsize, _seed=None):
  if _seed != None:
    ori_state = get_state()
    seed(_seed)
...
if __name__ == '__main__':
  ...
  if rank == 0:
    ...
    theta0 = init_rae_theta(embsize, _seed=_seed)
